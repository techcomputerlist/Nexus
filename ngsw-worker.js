...
${msgIdle}`, { headers: this.adapter.newHeaders({ 'Content-Type': 'text/plain' }) });
    ...
    const NOTIFICATION_OPTION_NNEXES = [
    ...
    class Driver {
        ...
        async handlePush(data) {
            ...
            let options = {};
            NOTIFICATION_OPTION_NNEXES.filter(name => desc.hasOwnProperty(name))
        ...
        async handleClick(notification, action) {
            ...
            NOTIFICATION_OPTION_NNEXES.filter(name => name in notification)
